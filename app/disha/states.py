...
GOAL_GUIDANCE: Dict[str, Dict[str, str]] = {
    ...
    "gu": {
        "coding": (
            "ચૂંકિ તમે સોફ્ટવેર/કોડિંગ કરિયરનું લક્ષ્ય રાખી રહ્યા છો, તેથી Computer Science, "
            "Mathematics & Computing, AI/Data Science અને IT બ્રાન્ચો તમારા માટે સૌથી ઉપર રાખવામાં આવી છે. "
            "કોડિંગ રોલ્સ માટે ચોક્કસ સંસ્થા કરતાં મજબૂત CS-સંબંધિત બ્રાન્ચ સામાન્ય રીતે વધુ મહત્વ ધરાવે છે, "
            "પરંતુ ઉચ્ચ-બ્રાન્ડવાળી સંસ્થા ઇન્ટર્નશિપ અને પ્લેસમેન્ટમાં મદદ કરે છે."
        ),
        "research": (
            "સંશોધન કે ઉચ્ચ અભ્યાસના માર્ગ માટે, મૂળભૂત-વિજ્ઞાન અને સંશોધન-સઘન પ્રોગ્રામ્સ "
        ...
        "mba": (
            ...
            "Economics, CS અને Maths & Computing જેવી ક્વોન્ટિટેટિવ બ્રાન્ચો થોડી મદદરૂપ બને છે."
        ),
        "core": (
            "કોર-એન્જિનિયરિંગ કરિયર માટે, Mechanical, Civil, Electrical, Chemical, Aerospace અને Materials બ્રાન્ચો "
            "સૌથી ઉપર રાખવામાં આવી છે. પ્રતિષ્ઠિત સંસ્થાઓની કોર બ્રાન્ચો (જ્યાં સારા કોર-સેક્ટર રિક્રુટર્સ અને લેબ્સ હોય) "
            "સૌથી શ્રેષ્ઠ ફિટ છે."
        ),
        "undecided": (
            "તમે હજી નક્કી કરી રહ્યા હોવાથી, આ સૂચિ બહુમુખી, ઉચ્ચ-માંગવાળી બ્રાન્ચો અને મજબૂત-બ્રાન્ડ ધરાવતી સંસ્થાઓને "
            "પસંદગી આપે છે જે ભવિષ્ય માટે સૌથી વધુ દરવાજા ખુલ્લા રાખે છે (કોડિંગ, ઉચ્ચ અભ્યાસ, કોર રોલ્સ અથવા પછીથી મેનેજમેન્ટ)."
        ),
    },
    "kn": {
        "coding": (
            "ನೀವು ಸಾಫ್ಟ್‌ವೇರ್/ಕೋಡಿಂಗ್ ವೃತ್ತಿಜೀವನವನ್ನು ಗುರಿಯಾಗಿಸಿಕೊಂಡಿರುವುದರಿಂದ, Computer Science, "
            "Mathematics & Computing, AI/Data Science ಮತ್ತು IT ಬ್ರಾಂಚ್‌ಗಳು ನಿಮಗಾಗಿ ಉನ್ನತ ಸ್ಥಾನದಲ್ಲಿವೆ. "
            "ಕೋಡಿಂಗ್ ಪಾತ್ರಗಳಿಗೆ ನಿಖರವಾದ ಸಂಸ್ಥೆಗಿಂತ ಬಲವಾದ CS-ಸಂಬಂಧಿತ ಬ್ರಾಂಚ್ ಸಾಮಾನ್ಯವಾಗಿ ಹೆಚ್ಚು ಮುಖ್ಯವಾಗಿದೆ, "
            "ಆದರೆ ಉನ್ನತ-ಬ್ರಾಂಡ್ ಸಂಸ್ಥೆಯು ಇಂಟರ್ನ್‌ಶಿಪ್ ಮತ್ತು ಉದ್ಯೋಗಾವಕಾಶಗಳಿಗೆ ಸಹಾಯ ಮಾಡುತ್ತದೆ."
        ),
        "research": (
        ...
        "mba": (
            ...
            "ಆದ್ದರಿಂದ ಉನ್ನತ ಶ್ರೇಣಿಯ ಸಂಸ್ಥೆಗಳಿಗೆ ಹೆಚ್ಚಿನ ಮೌಲ್ಯ ನೀಡಲಾಗುತ್ತದೆ. ಮುಂದೆ MBA ಮಾಡಲು ಯಾವುದೇ ಬ್ರಾಂಚ್ ಉತ್ತಮ; "
            "Economics, CS ಮತ್ತು Maths & Computing ನಂತಹ ಕ್ವಾಂಟಿಟೇಟಿವ್ ಬ್ರಾಂಚ್‌ಗಳು ಸ್ವಲ್ಪ ಹೆಚ್ಚುವರಿ ಅನುಕೂಲ ನೀಡುತ್ತವೆ."
        ),
        "core": (
            "ಕೋರ್-ಇಂಜಿನಿಯರಿಂಗ್ ವೃತ್ತಿಜೀವನಕ್ಕಾಗಿ, Mechanical, Civil, Electrical, Chemical, Aerospace ಮತ್ತು Materials "
            "ಬ್ರಾಂಚ್‌ಗಳು ಉನ್ನತ ಸ್ಥಾನದಲ್ಲಿವೆ. ಪ್ರತಿಷ್ಠಿತ ಸಂಸ್ಥೆಗಳಲ್ಲಿನ ಕೋರ್ ಬ್ರಾಂಚ್‌ಗಳು (ಉತ್ತಮ ಕೋರ್-ವಲಯದ ಕಂಪನಿಗಳು ಮತ್ತು ಲ್ಯಾಬ್‌ಗಳನ್ನು ಹೊಂದಿರುವ) "
            "ಅತ್ಯಂತ ಸೂಕ್ತವಾಗಿವೆ."
        ),
        "undecided": (
            "ನೀವು ಇನ್ನೂ ನಿರ್ಧರಿಸದ ಕಾರಣ, ಈ ಪಟ್ಟಿಯು ಬಹುಮುಖಿ, ಹೆಚ್ಚಿನ ಬೇಡಿಕೆಯಿರುವ ಬ್ರಾಂಚ್‌ಗಳು ಮತ್ತು ಬಲವಾದ-ಬ್ರಾಂಡ್ ಸಂಸ್ಥೆಗಳಿಗೆ "
            "ಆದ್ಯತೆ ನೀಡುತ್ತದೆ, ಇದು ಭವಿಷ್ಯದ ಎಲ್ಲಾ ದಾರಿಗಳನ್ನು ಮುಕ್ತವಾಗಿಡುತ್ತದೆ (ಕೋಡಿಂಗ್, ಉನ್ನತ ವ್ಯಾಸಂಗ, ಕೋರ್ ಪಾತ್ರಗಳು ಅಥವಾ ಮುಂದೆ ಮ್ಯಾನೇಜ್‌ಮೆಂಟ್)."
        ),
    },
}
...
# Reservation categories for JoSAA/CSAB seat allocation (josaa_merged_2025.csv).
VALID_CATEGORIES: list = [
    ...
    {"value": "OBC-NCL (PwD)", "label": "OBC-NCL (PwD)", "available": True},
    {"value": "SC (PwD)", "label": "SC (PwD)", "available": True},
    {"value": "ST (PwD)", "label": "ST (PwD)", "available": True},
    {"value": "EWS (PwD)", "label": "EWS (PwD)", "available": True},
]
