...
const I18N = {
  en: {
    ...
    review: {
      ...
      category: "Category", state: "Home state", goal: "Goal", branch: "Branch",
    ...
    nachiketa: {
      eyebrow: "From UTMT, the team behind this tool",
      title: "Bright mind, tight budget? Nachiketa has your back.",
      textHtml:
        "If you scored <strong>90+ percentile in JEE Mains</strong> and your family income is below ₹3 lakh a year, " +
        "UTMT's <strong>Nachiketa Initiative</strong> fully funds the IIT Madras online BS degree — " +
        "with a 4-year internship, mentorship and placement support.",
      cta: "Learn about Nachiketa",
    },
    footer: {
  ...
  hi: {
    ...
    review: {
      ...
      category: "श्रेणी", state: "होम स्टेट", goal: "लक्ष्य", branch: "ब्रांच",
    ...
    nachiketa: {
      eyebrow: "UTMT की ओर से, इस टूल को बनाने वाली टीम",
      title: "तेज़ दिमाग़, तंग बजट? Nachiketa आपके साथ है।",
      textHtml:
        "अगर आपने <strong>JEE Mains में 90+ percentile</strong> पाया है और आपके परिवार की सालाना आय ₹3 लाख से कम है, तो " +
        "UTMT की <strong>Nachiketa पहल</strong> IIT Madras की online BS डिग्री पूरी तरह funded करती है — " +
        "4-साल की internship, mentorship और placement सहायता के साथ।",
      cta: "Nachiketa के बारे में जानें",
    },
    footer: {
