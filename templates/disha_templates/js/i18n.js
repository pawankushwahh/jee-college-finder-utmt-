...
const I18N = {
  en: {
    ...
    flow: {
      ...
      s1Title: "What's your Category Rank?",
      s1Hint: "Enter whichever ranks you have — at least one. Enter your category rank (for General candidates, your CRL is your category rank).",
      categoryRankAlert: "<strong>Important:</strong> If you belong to OBC, SC, ST, or EWS, please enter your <strong>Category Rank</strong> here, NOT your General CRL rank. (For General candidates, your CRL is your category rank).",
      mainsLabel: "JEE Main category rank",
      mainsPlaceholder: "e.g. 12,500",
      mainsNote: "Used for NITs, IIITs and GFTIs. Enter your category rank.",
      advLabel: "JEE Advanced category rank",
      optional: "optional",
      advPlaceholder: "Leave blank if you didn't appear",
      advNote: "Used for IITs. Enter your category rank.",
      s2Eyebrow: "About you",
    ...
    review: {
      mains: "JEE Main category rank", adv: "JEE Advanced category rank", gender: "Gender",
    ...
    results: {
      ...
      priorityBranchShort: "Branch",
      priorityBalanced: "Balanced",
      priorityCollegeFull: "Favour College",
      priorityCollegeShort: "College",
      noGoalPrompt: "Set your Career Goal to get branch-specific rankings.",
      noGoalPromptAction: "Set Goal",
  ...
  hi: {
    ...
    flow: {
      ...
      kbdHint: "दबाएँ",
      s1Eyebrow: "सबसे पहले",
      s1Title: "आपकी कैटेगरी रैंक क्या है?",
      s1Hint: "आपके पास जो भी रैंक है वह डालें — कम से कम एक। अपनी कैटेगरी रैंक दर्ज करें (सामान्य उम्मीदवारों के लिए, आपकी CRL ही आपकी कैटेगरी रैंक है)।",
      categoryRankAlert: "<strong>महत्वपूर्ण:</strong> यदि आप OBC, SC, ST, या EWS श्रेणी के हैं, तो कृपया यहाँ अपनी <strong>कैटेगरी रैंक (Category Rank)</strong> दर्ज करें, अपनी जनरल CRL रैंक नहीं। (सामान्य श्रेणी के उम्मीदवारों के लिए, आपकी CRL ही आपकी कैटेगरी रैंक है)।",
      mainsLabel: "JEE Main कैटेगरी रैंक",
      mainsPlaceholder: "जैसे 12,500",
      mainsNote: "NITs, IIITs और GFTIs के लिए इस्तेमाल होती है। अपनी कैटेगरी रैंक (OBC, SC, ST, EWS आदि) दर्ज करें।",
      advLabel: "JEE Advanced कैटेगरी रैंक",
      optional: "वैकल्पिक",
      advPlaceholder: "अगर नहीं दी थी तो खाली छोड़ें",
      advNote: "IITs के लिए इस्तेमाल होती है। अपनी कैटेगरी रैंक दर्ज करें।",
    ...
    review: {
      mains: "JEE Main कैटेगरी रैंक", adv: "JEE Advanced कैटेगरी रैंक", gender: "जेंडर",
    ...
    results: {
      ...
      priorityBranchShort: "ब्रांच",
      priorityBalanced: "संतुलित",
      priorityCollegeFull: "कॉलेज को प्राथमिकता",
      priorityCollegeShort: "कॉलेज",
      noGoalPrompt: "ब्रांच-विशिष्ट रैंकिंग के लिए करियर लक्ष्य सेट करें।",
      noGoalPromptAction: "सेट करें",
      expandAll: "सभी खोलें",
  ...
  gu: {
    ...
    flow: {
      ...
      kbdHint: "દબાવો",
      s1Eyebrow: "સૌ પ્રથમ",
      s1Title: "તમારો કેટેગરી રેન્ક શું છે?",
      s1Hint: "તમારા કોઈપણ રેન્ક દાખલ કરો — ઓછામાં ઓછો એક. તમારી કેટેગરી રેન્ક દાખલ કરો (જનરલ ઉમેદવારો માટે, તમારી CRL એ જ તમારી કેટેગરી રેન્ક છે).",
      categoryRankAlert: "<strong>મહત્વપૂર્ણ:</strong> જો તમે OBC, SC, ST, અથવા EWS કેટેગરીના છો, તો કૃપા કરીને અહીં તમારી <strong>કેટેગરી રેન્ક (Category Rank)</strong> દાખલ કરો, તમારી જનરલ CRL રેન્ક નહીં. (જનરલ ઉમેદવારો માટે, તમારી CRL એ જ તમારી કેટેગરી રેન્ક છે).",
      mainsLabel: "JEE Main કેટેગરી રેન્ક",
      mainsPlaceholder: "દા.ત. 12,500",
      mainsNote: "NITs, IIITs અને GFTIs માટે વપરાય છે. તમારી કેટેગરી રેન્ક (OBC, SC, ST, EWS, વગેરે) દાખલ કરો.",
      advLabel: "JEE Advanced કેટેગરી રેન્ક",
      optional: "વૈકલ્પિક",
      advPlaceholder: "જો તમે પરીક્ષા ન આપી હોય તો ખાલી રાખો",
      advNote: "IITs માટે વપરાય છે. તમારી કેટેગરી રેન્ક દાખલ કરો.",
    ...
    review: {
      mains: "JEE Main કેટેગરી રેન્ક", adv: "JEE Advanced કેટેગરી રેન્ક", gender: "જાતિ",
    ...
    results: {
      ...
      priorityBranchShort: "બ્રાન્ચ",
      priorityBalanced: "સંતુલિત",
      priorityCollegeFull: "કોલેજને પ્રાધાન્ય",
      priorityCollegeShort: "કોલેજ",
      noGoalPrompt: "શાખા-વિશિષ્ટ રેન્કિંગ માટે કારકિર્દીનું લક્ષ્ય સેટ કરો.",
      noGoalPromptAction: "સેટ કરો",
  ...
  kn: {
    ...
    flow: {
      ...
      s1Title: "ನಿಮ್ಮ ಕೆಟಗರಿ ರ‍್ಯಾಂಕ್ ಎಷ್ಟು?",
      s1Hint: "ನಿಮ್ಮ ಯಾವುದೇ ರ‍್ಯಾಂಕ್‌ಗಳನ್ನು ನಮೂದಿಸಿ — ಕನಿಷ್ಠ ಒಂದು. ನಿಮ್ಮ ಕೆಟಗರಿ ರ‍್ಯಾಂಕ್ ಅನ್ನು ನಮೂದಿಸಿ (ಸಾಮಾನ್ಯ ಅಭ್ಯರ್ಥಿಗಳಿಗೆ, ನಿಮ್ಮ CRL ರ‍್ಯಾಂಕ್ ನಿಮ್ಮ ಕೆಟಗರಿ ರ‍್ಯಾಂಕ್ ಆಗಿದೆ).",
      categoryRankAlert: "<strong>ಪ್ರಮುಖ ಸೂಚನೆ:</strong> ನೀವು OBC, SC, ST, ಅಥವಾ EWS ವರ್ಗಕ್ಕೆ ಸೇರಿದ್ದರೆ, ದಯವಿಟ್ಟು ಇಲ್ಲಿ ನಿಮ್ಮ <strong>ಕೆಟಗರಿ ರ‍್ಯಾಂಕ್ (Category Rank)</strong> ಅನ್ನು ನಮೂದಿಸಿ, ನಿಮ್ಮ ಜನರಲ್ CRL ರ‍್ಯಾಂಕ್ ಅಲ್ಲ. (ಸಾಮಾನ್ಯ ಅಭ್ಯರ್ಥಿಗಳಿಗೆ, ನಿಮ್ಮ CRL ರ‍್ಯಾಂಕ್ ನಿಮ್ಮ ಕೆಟಗರಿ ರ‍್ಯಾಂಕ್ ಆಗಿದೆ).",
      mainsLabel: "JEE Main ಕೆಟಗರಿ ರ‍್ಯಾಂಕ್",
      mainsPlaceholder: "ಉದಾ: 12,500",
      mainsNote: "NITs, IIITs ಮತ್ತು GFTIs ಗೆ ಬಳಸಲಾಗುತ್ತದೆ. ನಿಮ್ಮ ಕೆಟಗರಿ ರ‍್ಯಾಂಕ್ (OBC, SC, ST, EWS, ಇತ್ಯಾದಿ) ನಮೂದಿಸಿ.",
      advLabel: "JEE Advanced ಕೆಟಗರಿ ರ‍್ಯಾಂಕ್",
      optional: "ಐಚ್ಛಿಕ",
      advPlaceholder: "ಪರೀಕ್ಷೆಗೆ ಹಾಜರಾಗದಿದ್ದರೆ ಖಾಲಿ ಬಿಡಿ",
      advNote: "IITs ಗೆ ಬಳಸಲಾಗುತ್ತದೆ. ನಿಮ್ಮ ಕೆಟಗರಿ ರ‍್ಯಾಂಕ್ ನಮೂದಿಸಿ.",
    ...
    review: {
      mains: "JEE Main ಕೆಟಗರಿ ರ‍್ಯಾಂಕ್", adv: "JEE Advanced ಕೆಟಗರಿ ರ‍್ಯಾಂಕ್", gender: "ಲಿಂಗ",
    ...
    results: {
      ...
      priorityBranchShort: "ಬ್ರಾಂಚ್",
      priorityBalanced: "ಸಮತೋಲನ",
      priorityCollegeFull: "ಕಾಲೇಜು ಆದ್ಯತೆ",
      priorityCollegeShort: "ಕಾಲೇಜು",
      noGoalPrompt: "ಬ್ರಾಂಚ್-ನಿರ್ದಿಷ್ಟ ಶ್ರೇಯಾಂಕಗಳಿಗಾಗಿ ವೃತ್ತಿ ಗುರಿಯನ್ನು ಹೊಂದಿಸಿ.",
      noGoalPromptAction: "ಹೊಂದಿಸಿ",
