...
const I18N = {
  en: {
    ...
    results: {
      ...
      collapse: "Collapse",
      sortLabel: "Sort by",
      sortCategory: "Match category (default)",
      sortProbability: "Admission chance (highest first)",
      sortRank: "Closing rank (most competitive first)",
      sortCollege: "College name (A-Z)",
      edit: "Edit",
      share: "Share",
      copyLink: "Copy link",
      copied: "Copied!",
  ...
  hi: {
    ...
    results: {
      ...
      expand: "खोलें",
      collapse: "समेटें",
      sortLabel: "सॉर्ट करें",
      sortCategory: "श्रेणी (डिफ़ॉल्ट)",
      sortProbability: "प्रवेश की संभावना (उच्चतम पहले)",
      sortRank: "कटऑफ़ रैंक (प्रतिस्पर्धी पहले)",
      sortCollege: "कॉलेज का नाम (A-Z)",
      edit: "बदलें",
      share: "शेयर करें",
  ...
  gu: {
    ...
    results: {
      ...
      collapseAll: "બધા સંકોચો",
      expand: "વિસ્તૃત કરો",
      collapse: "સંકોચો",
      sortLabel: "સૉર્ટ કરો",
      sortCategory: "મેળ શ્રેણી (ડિફૉલ્ટ)",
      sortProbability: "પ્રવેશ તક (સૌથી વધુ પહેલાં)",
      sortRank: "કટઓફ રેન્ક (સ્પર્ધાત્મક પહેલાં)",
      sortCollege: "કૉલેજ નામ (A-Z)",
      edit: "સુધારો",
      share: "શેર કરો",
  ...
  kn: {
    ...
    results: {
      ...
      expand: "ವಿಸ್ತರಿಸಿ",
      collapse: "ಕುಗ್ಗಿಸಿ",
      sortLabel: "ವರ್ಗೀಕರಿಸಿ",
      sortCategory: "ಹೊಂದಾಣಿಕೆ ವರ್ಗ (ಡೀಫಾಲ್ಟ್)",
      sortProbability: "ಪ್ರವೇಶ ಅವಕಾಶ (ಗರಿಷ್ಠ ಮೊದಲು)",
      sortRank: "ಕಟ್‌ಆಫ್ ರ‍್ಯಾಂಕ್ (ಸ್ಪರ್ಧಾತ್ಮಕ ಮೊದಲು)",
      sortCollege: "ಕಾಲೇಜು ಹೆಸರು (A-Z)",
      edit: "ಬದಲಾಯಿಸಿ",
      share: "ಹಂಚಿಕೊಳ್ಳಿ",
